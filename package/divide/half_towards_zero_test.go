...
func TestHalfTowardsZero(t *testing.T) {
	...
	for _, tc := range tests {
		got, err := divide.HalfTowardsZero[int]{}.Divide(tc.amount, tc.factor, c)
		if err != nil {
			if tc.expectErr {
				continue
			}
